...
internal class EnragedGuardian : TemplateBase
{
    ...
    {
        ("GG_Crystal_Guardian_2", "Battle Scene"),
        ("GG_Crystal_Guardian_2", "Laser Turret Mega"),
    };
    public override void Initialize(Dictionary<string, Dictionary<string, GameObject>> preloadedObjects)
    {
        var battleScene = Load.Preload(preloadedObjects, "GG_Crystal_Guardian_2", "Battle Scene");
        prefab = battleScene.transform.Find("Zombie Beam Miner Rematch").gameObject;
        laser = Load.Preload(preloadedObjects, "GG_Crystal_Guardian_2", "Laser Turret Mega");
    }
    ...
    protected override void RewriteInstance(GameObject gameObject, PlaceConfig properties)
    {
        ...
        fsm.RemoveAction("Init", fsm.GetState("Init").Actions.Length - 1);
        ...
        fsm.AddTransition("Init", "FINISHED", "Battle Init");
        ...
        fsm.RemoveAction("Laser Shoot", 0);
        fsm.AddCustomAction("Laser Shoot", () =>
        {
            var currentX = fsm.gameObject.transform.position.x;
        ...
        fsm.InsertCustomAction("Range Check 2", () => { fsm.SendEvent("FINISHED"); }, 0);
