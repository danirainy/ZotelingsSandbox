...
internal class HornetProtector : TemplateBase
{
    ...
    {
        ("GG_Hornet_1", "Boss Holder"),
    };
    public override void Initialize(Dictionary<string, Dictionary<string, GameObject>> preloadedObjects)
    {
        var bossHolder = Load.Preload(preloadedObjects, "GG_Hornet_1", "Boss Holder");
        prefab = bossHolder.transform.Find("Hornet Boss 1").gameObject;
    }
    ...
    protected override void RewriteInstance(GameObject gameObject, PlaceConfig properties)
    {
        ...
        fsm.RemoveAction("Refight Ready", 4);
        fsm.AddCustomAction("Refight Ready", () =>
        {
            fsm.SendEvent("WAKE");
        });
        fsm.AddCustomAction("Refight Wake", () =>
        {
            fsm.SetState("Idle");
        });
